...
<div class="newscontainer"> <!--News container-->
  ...
  $results = $mysqli->query("SELECT * FROM `teams` ORDER BY `name`");
    if ($results) { 
        ...
        while($obj = $results->fetch_object())
  {
    ...
    echo '<div class="lagdiv">';
      ...
      echo '<a href="'.$obj->URL.'">'.$obj->name.'</a>';
    echo '</div>'; 
...
?>
 ...
 <!-- <div class="lagdiv" style="margin-top:5px;">
    <img class="logolagsida" src="images/colorado.png">
    <a href="#">Anaheim Ducks</a>
  </div>

  <div class="lagdiv1">
    <img class="logolagsida" src="images/boston.png">
    <a href="#">Anaheim Ducks</a>
  </div>
